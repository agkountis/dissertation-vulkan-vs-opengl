...
bool VulkanRenderPass::Create(VkDevice logicalDevice, VkFormat colorFormat, VkFormat depthFormat) noexcept
{
	...
	VkResult result{ vkCreateRenderPass(m_pLogicalDevice, &renderPassInfo, nullptr, &m_RenderPass) };
...
VulkanRenderPass::operator VkRenderPass() const noexcept
{
	return m_RenderPass;
}
