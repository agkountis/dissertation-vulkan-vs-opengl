...
struct QueueFamilyIndices {
    ...
    ui32 present{std::numeric_limits<ui32>::max()};
};
...
public:
    ...
    std::vector<VkCommandBuffer> CreateCommandBuffers(ui32 count,
    ...
    ui32 GetQueueFamilyIndex(QueueFamily queueFamily) const noexcept;
